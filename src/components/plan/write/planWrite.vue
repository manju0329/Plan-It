<script setup>
import planWriteList from './planWriteList.vue';
import planWriteMap from './planWriteMap.vue';
import planWriteSearch from './planWriteSearch.vue';
import planWriteAttr from './planWriteAttr.vue';
        ...
        <div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <button type="submit" class="btn btn-warning" @click.self.prevent="writePlan">추가하기</button>
                </div>
              </div>
              <div class="path">
